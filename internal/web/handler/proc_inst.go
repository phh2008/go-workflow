...
func (h *ProcInstHandler) Start(c *gin.Context) {
	...
	id, err := h.engine.InstanceStart(c.Request.Context(), req)
	if err != nil {
		c.JSON(http.StatusBadRequest, err.Error())
		return
	}
...
func (h *ProcInstHandler) Revoke(c *gin.Context) {
	...
	if err := h.engine.InstanceRevoke(c.Request.Context(), req); err != nil {
		c.JSON(http.StatusBadRequest, err.Error())
		return
	}
...
func (h *ProcInstHandler) StartByUser(c *gin.Context) {
	...
	result, err := h.engine.GetInstanceStartByUser(c.Request.Context(), req)
	if err != nil {
		c.JSON(http.StatusBadRequest, err.Error())
		return
	}
